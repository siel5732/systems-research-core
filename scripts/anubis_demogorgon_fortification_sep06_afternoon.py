...
def run_dizzy_afternoon_acoustic_calibration():
    ...
    shifted to exactly 15206.3 Hz due to active thermal operating parameters and afternoon loads.
    ...
    resonance_frequency = 15206.3  # Calibrated 3:00 PM resonance frequency under afternoon conditions
